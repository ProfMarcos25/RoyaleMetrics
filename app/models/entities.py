"""
Modelos SQLAlchemy â€” Royle Metrics
...
class Clan(Base):
    """
    ClÃ£s monitorados pelo projeto Royle Metrics.
    Um clÃ£ pode ter vÃ¡rios jogadores e vÃ¡rias guerras.
    """
    __tablename__ = "clans"
...
class Jogador(Base):
    """
    Jogadores (membros dos clÃ£s) coletados via API.
    ContÃ©m dados de perfil e referÃªncia ao clÃ£ atual.
    """
...
class Torneio(Base):
    """
    Torneios escolares registrados manualmente ou via formulÃ¡rio.
    Representa competiÃ§Ãµes realizadas na unidade escolar.
    """
...
class Batalha(Base):
    ...
    O campo battle_id garante que batalhas duplicadas nÃ£o sejam inseridas.
    """
...
class BatalhaCartas(Base):
    """
    Tabela intermediÃ¡ria: cartas usadas em cada batalha.
    Representa o deck do jogador em uma batalha especÃ­fica.
    """
...
class Guerra(Base):
    ...
    Cada guerra contÃ©m o desempenho geral do clÃ£ na temporada.
    """
...
class ContribuicaoGuerra(Base):
    """
    ContribuiÃ§Ã£o individual de cada jogador em uma guerra.
    O campo fame Ã© a mÃ©trica principal do River Race.
    """
